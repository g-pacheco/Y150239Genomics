...
levels(fit_data$File <- sub("AllSamples_bcftools.raw.vcf.Filtered.Allosome.NoKinship.NoTreeSparrow.MAFfiltered.LD.gz", "No Pruning", fit_data$File))


# Corrects LD State (ld_data) ~
levels(ld_data$File <- sub("AllSamples_bcftools.raw.vcf.Filtered.Allosome.NoKinship.NoTreeSparrow.MAFfiltered.LD.gz", "No Pruning", ld_data$File))
